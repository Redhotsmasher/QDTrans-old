...
test0a: common.o printer.o qdtrans.o
	$(CC) tests/Test0a.c $(CFLAGS) --verbose bin/common.o bin/printer.o bin/qdtrans.o -o bin/test0a

test0b: common.o printer.o qdtrans.o
	$(CC) tests/Test0b.c $(CFLAGS) --verbose bin/common.o bin/printer.o bin/qdtrans.o -o bin/test0b

test0c: common.o printer.o qdtrans.o
	$(CC) tests/Test0c.c $(CFLAGS) --verbose bin/common.o bin/printer.o bin/qdtrans.o -o bin/test0c
